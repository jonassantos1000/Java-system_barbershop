...
public class AlterarCliente extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        cod_cliente.setFont(new java.awt.Font("Verdana", 1, 12)); // NOI18N
    ...
    private void setValue(){
        ...
        Cliente resultselectaltera = new Cliente(id,"","","","");
        resultselectaltera.selectAlteraCliente(id);
        ...
        txtBairro.setText(resultselectaltera.getresultalteracliente().getBairro());
        txtCEP.setText(resultselectaltera.getresultalteracliente().getCEP());
        txtEmail.setText(resultselectaltera.getresultalteracliente().getEmail());
