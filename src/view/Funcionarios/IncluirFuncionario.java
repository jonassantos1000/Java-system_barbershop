    ...
    private void btSalvarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btSalvarActionPerformed
        if("".equals(txtnome.getText()) ){
            ...
            try {
                ...
                Funcionario incluirFuncionario = new Funcionario(codigo,nome,CPF,RG,celular,email,data,endereco,bairro,numero,complemento,telefone,observacao, CEP);
                incluirFuncionario.gravar(incluirFuncionario);
