...
public class AlterarFuncionario extends javax.swing.JFrame {
    ...
    private void btSalvarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btSalvarActionPerformed
        if("".equals(txtnome.getText()) ){
            ...
            try {
                ...
                Funcionario alterarFuncionario = new Funcionario(codigo,nome,CPF,RG,celular,email,data,endereco,bairro,numero,complemento,telefone,observacao, CEP);
                alterarFuncionario.alterar(alterarFuncionario);
    ...
    private void setValue(){
        try{
            ...
            Funcionario resultselectaltera = new Funcionario(id,"","","","");
            resultselectaltera.selectAlteraFuncionario(id);
            txtnome.setText(resultselectaltera.getresultalterafuncionario().getNome());
            txtCPF.setText(resultselectaltera.getresultalterafuncionario().getCPF());
            txtRG.setText(resultselectaltera.getresultalterafuncionario().getRG());
            txtData.setText(data.formataDataBD(resultselectaltera.getresultalterafuncionario().getData()));
            txtEndereco.setText(resultselectaltera.getresultalterafuncionario().getEndereco());
            txtNumero.setText(resultselectaltera.getresultalterafuncionario().getNumero());
            txtComplemento.setText(resultselectaltera.getresultalterafuncionario().getComplemento());
            txtBairro.setText(resultselectaltera.getresultalterafuncionario().getBairro());
            txtCEP.setText(resultselectaltera.getresultalterafuncionario().getCEP());
            txtEmail.setText(resultselectaltera.getresultalterafuncionario().getEmail());
            txtTelefone.setText(resultselectaltera.getresultalterafuncionario().getTelefone());
            txtCelular.setText(resultselectaltera.getresultalterafuncionario().getCelular());
            txtObservacao.setText(resultselectaltera.getresultalterafuncionario().getObservacao());
            txtDataAlteracao.setText(data.formataDataBD(coalesceData(resultselectaltera.getresultalterafuncionario().getData_alteracao())));
        }catch(Exception ex){
            ex.printStackTrace();
        }    
    }  
